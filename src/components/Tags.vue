...
export default {
  ...
  props: {
    /* Datas */
    UsedTagIds: {
      describ: '正在使用的标签所对应的 id 数组，如: [2, 3, 6]',
      type: Array,
      default() {
        return [];
      }
    ...
    AllTags: {
      describ: '所有的标签项目数组，如: {1: {name: "Github", color: "#213123"}}',
      type: Object,
      default() {
        return {};
      }
    ...
    NextTagId: {
      describ: '全局 id 指示器，新增的标签 id 就会使用这个值并且将其自增 1',
      type: Number,
      default: null
    },
    Placeholder: {
    ...
    AutoComplite: {
      describ: '在输入框中自动补全，会多消耗一丢丢性能',
      type: Boolean | String,
      default: false
    },
    AllowPasteToAdd: {
      describ: '允许通过粘贴直接添加标签',
      type: Boolean | String,
      default: true
    },
    ...
    */
    ...
    /* Styles */
    WarningLength: {
      describ: '标签输入框中输入超过设定值数量的字符，输入字体颜色将改变',
      type: Number,
      default: 18
    }
  },
